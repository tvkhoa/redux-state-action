(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["stateAction"] = factory(root["ReduxAction"], root["redux"], root["reselect"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_79__, __WEBPACK_EXTERNAL_MODULE_80__) {
...
var _isString = __webpack_require__(202);
...
var arrayReduce = __webpack_require__(24),
    ...
    baseReduce = __webpack_require__(130),
    isArray = __webpack_require__(0);
...
var baseClone = __webpack_require__(46),
    baseMatches = __webpack_require__(51);
...
var _mapValues = __webpack_require__(204);
...
var _shared = __webpack_require__(94);
...
var _boolean = __webpack_require__(86);
...
var getActionHandlersByType = exports.getActionHandlersByType = function getActionHandlersByType(type) {
  ...
  return (0, _get2.default)(values, type, _shared2.default);
};
...
var getActionsDataSet = exports.getActionsDataSet = function getActionsDataSet(_ref) {
  ...
  return (0, _mapValues2.default)(actions, function (actionHandler) {
...
var getDefaultValueByType = function getDefaultValueByType(type) {
  ...
  return (0, _get2.default)(values, type, '');
};
...
var _matches = __webpack_require__(74);

var _matches2 = _interopRequireDefault(_matches);

var _getType = __webpack_require__(10);
...
exports.default = function (_ref) {
  ...
  var reducerHandler = _defineProperty({}, actionType, function () {
    ...
    var condition = (0, _get2.default)(action, 'payload');
    var conditionType = (0, _getType2.default)(condition);
    if (conditionType === 'object') {
      return (0, _filter2.default)(state, (0, _matches2.default)(condition));
    }
...
var _pushToFirst = __webpack_require__(84);
...
var _remove = __webpack_require__(85);
...
exports.default = function (_ref) {
  ...
  var reducerHandler = _defineProperty({}, actionType, function () {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    var action = arguments[1];
    return [].concat(_toConsumableArray(state), [(0, _get2.default)(action, 'payload')]);
  });
...
exports.default = function (_ref) {
  ...
  var reducerHandler = _defineProperty({}, actionType, function () {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    var action = arguments[1];
    return [(0, _get2.default)(action, 'payload')].concat(_toConsumableArray(state));
  });
...
var _without = __webpack_require__(210);
  ...
  var reducerHandler = _defineProperty({}, actionType, function () {
    ...
    if (conditionType === 'object') {
      return (0, _filter2.default)(state, function (item) {
        return !(0, _matches2.default)(condition)(item);
      });
    }
    if (conditionType === 'array') {
      return _without2.default.apply(undefined, [state].concat(_toConsumableArray(condition)));
    }
    return (0, _without2.default)(state, condition);
  });
...
exports.default = function (_ref) {
  ...
  var reducerHandler = _defineProperty({}, actionType, function (state, action) {
    return state - (0, _get2.default)(action, 'payload', 0);
  });
...
var _increase = __webpack_require__(89);

var _increase2 = _interopRequireDefault(_increase);

var _decrease = __webpack_require__(88);
...
exports.default = function (_ref) {
  ...
  var reducerHandler = _defineProperty({}, actionType, function () {
    ...
    var value = (0, _get2.default)(action, 'payload', {});
...
exports.default = function (_ref) {
  ...
  var reducerHandler = _defineProperty({}, actionType, function () {
    ...
    return (0, _omit2.default)(state, value);
  });
...
exports.default = function (_ref) {
  ...
  var reducerHandler = _defineProperty({}, actionType, function () {
    ...
    var value = (0, _get2.default)(action, 'payload', defaultValue);
    var valueType = (0, _getType2.default)(value);
    if (type !== valueType) {
...
var _defaultValues = __webpack_require__(77);
...
var getOption = function getOption(nameValue) {
  if ((0, _isObject2.default)(nameValue)) {
    return nameValue;
  }
  return {
    type: nameValue
...
var makeStateAction = function makeStateAction(_ref) {
  ...
  var domainSelector = function domainSelector(state) {
    return (0, _get2.default)(state, reducerPath);
  };
  var results = (0, _reduce2.default)(names, function (result, nameValue, name) {
    var option = getOption(nameValue);

    var type = (0, _get2.default)(option, 'type', 'string');
    var defaultValue = (0, _get2.default)(option, 'defaultValue', (0, _defaultValues2.default)(type));
    var reducerHandlers = (0, _get2.default)(option, 'reducerHandlers', {});
    ...
    var selector = (0, _reselect.createSelector)(domainSelector, function (domain) {
      return (0, _get2.default)(domain, '' + name);
    });
  ...
  var actionTypeFactory = function actionTypeFactory(varName) {
    ...
    var actionTypesSet = (0, _get2.default)(results.actionTypes, varName);
    if (actionTypesSet === undefined) {
      console.warn('Cannot find actionType for', varName, '. Please check your code');
      return undefined;
    }
    var actionType = (0, _get2.default)(actionTypesSet, type);
    if (actionType === undefined) {
      var supportedTypes = (0, _join2.default)((0, _keys2.default)(actionTypesSet), ', ');
  ...
  var actionCreatorFactory = function actionCreatorFactory(varName) {
    ...
    var actionCreatorsSet = (0, _get2.default)(results.actionCreators, varName);
    if (actionCreatorsSet === undefined) {
      console.warn('Cannot find actionCreator for', varName, '. Please check your code');
      return undefined;
    }
    var actionCreator = (0, _get2.default)(actionCreatorsSet, type);
    if (actionCreator === undefined) {
      var supportedTypes = (0, _join2.default)((0, _keys2.default)(actionCreatorsSet), ', ');
  ...
  var selectorFactory = function selectorFactory(varName) {
    var selector = (0, _get2.default)(results.selectors, varName);
...
var addMapEntry = __webpack_require__(102),
...
var addSetEntry = __webpack_require__(103),
    arrayReduce = __webpack_require__(24),
...
var isPlainObject = __webpack_require__(201);
...
var arrayMap = __webpack_require__(22),
    ...
    baseUnset = __webpack_require__(136),
